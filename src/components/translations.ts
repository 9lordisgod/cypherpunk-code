...
const en = {
  ...
  discordTitle: "Join the private group",
  discordDescription:
    "This is a private community. If you'd like to join, contact {handle} on X. Membership requires meeting in person, face to face.",
  discordJoin: "Contact {handle}",
  discordLabel: "Private group",
...
const zhCN: TranslationStrings = {
  ...
  discordTitle: "加入私人小组",
  discordDescription:
    "这是一个私人社区。如需加入，请在 X 上联系 {handle}。会员资格需要面对面、实地会面。",
  discordJoin: "联系 {handle}",
  discordLabel: "私人小组",
...
const ja: TranslationStrings = {
  ...
  discordTitle: "プライベートグループに参加",
  discordDescription:
    "これはプライベートなコミュニティです。参加を希望する場合は、X で {handle} にご連絡ください。メンバーシップには対面での会合が必要です。",
  discordJoin: "{handle} に連絡",
  discordLabel: "プライベートグループ",
...
const fr: TranslationStrings = {
  ...
  discordTitle: "Rejoindre le groupe privé",
  discordDescription:
    "Il s'agit d'une communauté privée. Pour rejoindre, contactez {handle} sur X. L'adhésion nécessite une rencontre en personne, face à face.",
  discordJoin: "Contacter {handle}",
  discordLabel: "Groupe privé",
