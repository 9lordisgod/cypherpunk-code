export const pageStringsEn = {
  ...
  aboutCommunityText:
    "The {label} community is private. To join, contact {handle} on X — membership requires meeting in person, face to face.",
...
export const pageStringsZhCN = {
  ...
  aboutCommunityText:
    "{label} 社区为私人小组。如需加入，请在 X 上联系 {handle} — 会员资格需要面对面、实地会面。",
  aboutContribute: "贡献",
...
export const pageStringsJa = {
  ...
  aboutCommunityText:
    "{label} はプライベートなコミュニティです。参加を希望する場合は、X で {handle} にご連絡ください — メンバーシップには対面での会合が必要です。",
  aboutContribute: "貢献",
...
export const pageStringsFr = {
  ...
  aboutCommunityText:
    "La communauté {label} est privée. Pour rejoindre, contactez {handle} sur X — l'adhésion nécessite une rencontre en personne, face à face.",
