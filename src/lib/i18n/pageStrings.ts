export const pageStringsEn = {
  ...
  aboutWhoBuiltText:
    "Curated and maintained by {handle}. The initial database was seeded from public sources including the Nakamoto Institute, Monero Project, MIT OpenCourseWare, Princeton, Chaincode Labs, and community guides.",
  ...
  roadmapPhase1Item1:
    "68 curated resources across Bitcoin, Monero, OpSec & cypherpunk history",
  ...
  docBannerDescription:
    "Learn how to study from the ground up, get the most from the platform, and follow our roadmap.",
  ...
  adminLoginSubtitle: "Operator sign-in for analytics and feedback review.",
  adminLoginEmailLabel: "Email",
...
export const pageStringsZhCN = {
  ...
  aboutWhoBuilt: "谁建造的？",
  aboutWhoBuiltText:
    "由 {handle} 策划和维护。初始数据库来自公开来源，包括 Nakamoto Institute、Monero Project、MIT OpenCourseWare、Princeton、Chaincode Labs 和社区指南。",
  aboutCpScore: "密码朋克评分",
  aboutCpScoreText:
  ...
  roadmapPhase1Item1: "68 个精选资源，涵盖比特币、门罗币、操作安全和密码朋克历史",
  ...
  adminLoginSubtitle: "运营者登录，查看分析与反馈。",
  adminLoginEmailLabel: "邮箱",
  adminLoginPasswordLabel: "密码",
  adminLoginSubmit: "登录",
  adminLoginSubmitting: "登录中…",
  adminLoginError: "邮箱或密码无效。",
...
export const pageStringsJa = {
  ...
  aboutWhoBuilt: "誰が作った？",
  aboutWhoBuiltText:
    "{handle} によってキュレーション・維持。初期データベースは Nakamoto Institute、Monero Project、MIT OpenCourseWare、Princeton、Chaincode Labs、コミュニティガイドなどの公開ソースから構築。",
  ...
  roadmapPhase1Item1:
    "ビットコイン、モネロ、OpSec、サイファーパンク史にわたる68件の厳選リソース",
  ...
  adminLoginSubtitle: "運営者向けサインイン — 分析とフィードバックの確認。",
  adminLoginEmailLabel: "メール",
  adminLoginPasswordLabel: "パスワード",
  adminLoginSubmit: "サインイン",
  adminLoginSubmitting: "サインイン中…",
  adminLoginError: "メールまたはパスワードが無効です。",
...
export const pageStringsFr = {
  ...
  aboutWhoBuiltText:
    "Curaté et maintenu par {handle}. La base de données initiale provient de sources publiques dont le Nakamoto Institute, Monero Project, MIT OpenCourseWare, Princeton, Chaincode Labs et des guides communautaires.",
  ...
  roadmapPhase1Item1:
    "68 ressources curatées sur Bitcoin, Monero, OpSec et histoire cypherpunk",
  ...
  adminLoginSubtitle: "Connexion opérateur pour les analyses et retours.",
  adminLoginEmailLabel: "E-mail",
  adminLoginPasswordLabel: "Mot de passe",
  adminLoginSubmit: "Se connecter",
  adminLoginSubmitting: "Connexion…",
  adminLoginError: "E-mail ou mot de passe invalide.",
