export const pageStringsEn = {
  ...
  adminLoginSubtitle: "View learner progress and feedback in real time.",
...
export const pageStringsZhCN = {
  ...
  adminLoginSubtitle: "实时查看学习者进度与反馈。",
  adminPassword: "密码",
  adminLoginButton: "登录管理后台",
  adminLoginError: "管理员凭据无效。",
...
export const pageStringsJa = {
  ...
  adminLoginSubtitle: "学習者の進捗とフィードバックをリアルタイムで確認。",
  adminPassword: "パスワード",
  adminLoginButton: "管理にサインイン",
  adminLoginError: "管理者の認証情報が無効です。",
...
export const pageStringsFr = {
  ...
  adminLoginSubtitle: "Consultez la progression et les commentaires des apprenants en temps réel.",
  adminPassword: "Mot de passe",
  adminLoginButton: "Connexion admin",
  adminLoginError: "Identifiants admin invalides.",
